...
class Settings(BaseSettings):
    ...
    llmq_chat_model: str = Field(default="gpt-5-mini")
    daily_report_llm_model: str = Field(default="gpt-5-mini")
    market_context_llm_model: str = Field(default="gpt-5-mini")
    final_28d_review_llm_model: str = Field(default="gpt-5.4-mini")
